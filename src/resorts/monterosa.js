...
export const RUNS = [
  ...
  ["p66", "pianalungabocchetta", "Down to Pianalunga-Bocchetta", "red", 0.4, 2],
  ["p67", "p68", "Above Sant'Anna to Pistone Betta", "red", 0.1, 2],
  ...
  ["p49", "p68", "Above Sant'Anna to Pistone Betta", "red", 0.2, 2],
  ...
  ["p86", "crest3", "Ostafa 1 to Crest", "red", 0.3, 2],
  ["crest2", "crest", "Fontaney 2", "blue", 0.1, 2],
  ["p40", "alpeostafa", "Sarezza Variante", "red", 0.3, 2],
  ["alpeostafa2", "p89", "Alpe Ostafa to Ostafa 1", "red", 0.3, 2],
  ["p49", "p68", "Pistone Betta", "red", 0.2, 2],
  ["p90", "p67", "Pistone Betta to Above Sant'Anna", "red", 0.3, 2],
