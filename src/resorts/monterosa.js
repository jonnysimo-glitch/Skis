...
export const NODES = {
  ...
  p5:                    { name: "Point 5",                lat: 45.84895, lon: 7.75478, alt: 2219, area: "Ayas" },
  ...
  p31:                   { name: "Champoluc",              lat: 45.83649, lon: 7.73148, alt: 1584, area: "Ayas", base: true, rifugio: true },
  ...
  p37:                   { name: "Point 37",               lat: 45.87262, lon: 7.87591, alt: 2811, area: "Alagna" },
  collesarezza2:         { name: "Colle Sarezza",          lat: 45.83695, lon: 7.76899, alt: 2634, area: "Ayas" },
  p40:                   { name: "Point 40",               lat: 45.83532, lon: 7.76518, alt: 2505, area: "Ayas" },
  p41:                   { name: "Point 41",               lat: 45.83081, lon: 7.76084, alt: 2300, area: "Ayas" },
  p43:                   { name: "Point 43",               lat: 45.84907, lon: 7.75599, alt: 2231, area: "Ayas" },
  p44:                   { name: "Point 44",               lat: 45.85583, lon: 7.74922, alt: 2165, area: "Ayas" },
  p45:                   { name: "Point 45",               lat: 45.85764, lon: 7.74717, alt: 2113, area: "Ayas" },
  p46:                   { name: "Point 46",               lat: 45.86634, lon: 7.78672, alt: 2585, area: "Gressoney" },
  p47:                   { name: "Point 47",               lat: 45.86069, lon: 7.80351, alt: 2091, area: "Gressoney" },
  p48:                   { name: "Point 48",               lat: 45.86260, lon: 7.79111, alt: 2474, area: "Gressoney" },
  p49:                   { name: "Point 49",               lat: 45.85889, lon: 7.79549, alt: 2320, area: "Gressoney" },
  ...
  p53:                   { name: "Point 53",               lat: 45.85361, lon: 7.83672, alt: 2258, area: "Gressoney" },
  p54:                   { name: "Point 54",               lat: 45.84363, lon: 7.82552, alt: 1972, area: "Gressoney" },
  p55:                   { name: "Point 55",               lat: 45.82977, lon: 7.75216, alt: 2095, area: "Ayas" },
  ...
  p59:                   { name: "Point 59",               lat: 45.85807, lon: 7.75133, alt: 2230, area: "Ayas" },
  ...
  p63:                   { name: "Point 63",               lat: 45.85933, lon: 7.75284, alt: 2260, area: "Ayas", rifugio: true },
  p64:                   { name: "Point 64",               lat: 45.87346, lon: 7.88286, alt: 2731, area: "Alagna" },
  passodeisalati3:       { name: "Passo dei Salati",       lat: 45.87676, lon: 7.87019, alt: 2922, area: "Gressoney" },
  p66:                   { name: "Point 66",               lat: 45.86603, lon: 7.90081, alt: 2073, area: "Alagna" },
  p67:                   { name: "Point 67",               lat: 45.85799, lon: 7.79865, alt: 2279, area: "Gressoney", rifugio: true },
  p68:                   { name: "Point 68",               lat: 45.85765, lon: 7.79715, alt: 2270, area: "Gressoney" },
  p69:                   { name: "Point 69",               lat: 45.84325, lon: 7.83068, alt: 2132, area: "Gressoney" },
  p70:                   { name: "Point 70",               lat: 45.87322, lon: 7.90479, alt: 2323, area: "Alagna" },
  p71:                   { name: "Point 71",               lat: 45.86790, lon: 7.90766, alt: 2087, area: "Alagna" },
  p74:                   { name: "Point 74",               lat: 45.85831, lon: 7.84765, alt: 2398, area: "Gressoney" },
  p75:                   { name: "Point 75",               lat: 45.86722, lon: 7.85945, alt: 2666, area: "Gressoney" },
  ...
  p82:                   { name: "Point 82",               lat: 45.85617, lon: 7.75927, alt: 2376, area: "Ayas" },
  p83:                   { name: "Point 83",               lat: 45.85555, lon: 7.75421, alt: 2309, area: "Ayas" },
  p84:                   { name: "Point 84",               lat: 45.83191, lon: 7.75827, alt: 2275, area: "Ayas" },
  p85:                   { name: "Point 85",               lat: 45.83073, lon: 7.75498, alt: 2175, area: "Ayas" },
  p86:                   { name: "Point 86",               lat: 45.83093, lon: 7.74734, alt: 2007, area: "Ayas", rifugio: true },
  ...
  p89:                   { name: "Point 89",               lat: 45.83181, lon: 7.76081, alt: 2332, area: "Ayas" },
  p90:                   { name: "Point 90",               lat: 45.85975, lon: 7.79503, alt: 2354, area: "Gressoney" },
  p91:                   { name: "Point 91",               lat: 45.83637, lon: 7.76737, alt: 2575, area: "Ayas" },
};

/** [from, to, name, type, rideMinutes, lastUpMinuteOfDay, typicalQueueMinutes] */
export const LIFTS = [
  ["pianalungabocchetta", "passodeisalati", "Pianalunga - Cimalegna - Salati", "cable car", 7, 960, 5],
  ["alpeostafa", "collesarezza", "Alpe Ostafa - Colle Sarezza II", "chair", 8, 960, 5],
  ["p5", "lagociarcerio", "Lago Ciarcerio - Belvedere", "chair", 5, 960, 5],
  ["gabiet", "passodeisalati", "Gabiet - Passo dei Salati", "gondola", 12, 960, 5],
  ["gabiet", "lago", "Gabiet - Lago", "chair", 3, 960, 5],
  ["crest", "alpeostafa", "Crest - Alpe Ostafa III", "gondola", 6, 960, 5],
  ["puntajolanda", "puntajolanda2", "Punta Jolanda", "chair", 10, 960, 5],
  ["alpemandria", "alpemandria2", "Alpe Mandria", "chair", 6, 960, 5],
  ["stafal", "santanna", "Stafal - Sant'Anna", "cable car", 2, 960, 5],
  ["santanna", "collebetta", "Sant'Anna - Colle Betta", "chair", 9, 960, 5],
  ["bedemie", "seehorn", "Bedemie - Seehorn", "chair", 12, 960, 5],
  ["stafal", "gabiet", "Stafal - Gabiet", "gondola", 9, 960, 5],
  ["bettaforca", "bettaforca2", "Bettaforca", "chair", 6, 960, 5],
  ["pianalungabocchetta2", "bocchetta", "Pianalunga - Bocchetta", "chair", 8, 960, 5],
  ["crest", "crest2", "Fontaney 2", "carpet", 6, 960, 5],
  ["cimalegna", "collesalati", "Cimalegna-Passo Salati", "chair", 7, 960, 5],
  ["p31", "crest", "Champoluc - Crest", "gondola", 5, 960, 5],
