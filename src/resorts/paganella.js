 ...
 *
 * Source:    OpenStreetMap via the Overpass API, 2026-09-05T17:28:54.502Z
...
export const NODES = {
  ...
  p24:               { name: "Above Laghet - Doss",   lat: 46.15613, lon: 11.00307, alt: 1145, area: "Andalo", named: false },
  ...
  p30:               { name: "Above Laghet - Doss",   lat: 46.15672, lon: 11.00455, alt: 1124, area: "Andalo", named: false },
  ...
  p33:               { name: "Above Laghet - Doss",   lat: 46.15436, lon: 11.00174, alt: 1189, area: "Andalo", named: false },
  p34:               { name: "Above Albi de Mez",     lat: 46.14490, lon: 11.03007, alt: 1919, area: "Andalo", named: false },
  p35:               { name: "Above Albi de Mez",     lat: 46.14885, lon: 11.02816, alt: 1794, area: "Andalo", named: false },
  ...
  p38:               { name: "Above Meriz",           lat: 46.15827, lon: 11.04604, alt: 1618, area: "Fai", named: false },
  ...
  p47:               { name: "Above Teresat",         lat: 46.14655, lon: 11.00237, alt: 1456, area: "Andalo", named: false },
  p48:               { name: "Below Albi de Mez",     lat: 46.15261, lon: 11.02476, alt: 1671, area: "Andalo", named: false },
...
export const RUNS = [
  ...
  ["albidemez2", "p6", "Olimpionica 3", "red", 0.3, 2],
  ["paganella", "cimapaganella2", "Olimpionica 3", "red", 0.2, 2],
  ["cimapaganella2", "p34", "Olimpionica 3", "red", 0.5, 2],
  ["p34", "albidemez2", "Olimpionica 3", "red", 0.4, 2],
  ...
  ["piandosson2", "p30", "Olimpionica 1", "red", 1.1, 4],
  ["piandosson3", "intermediadosson", "Cacciatori 1", "blue", 0.1, 2],
  ["intermediadosson", "intermediadosson2", "Cacciatori 1", "blue", 0.2, 2],
  ["intermediadosson2", "p33", "Cacciatori 1", "blue", 1.2, 4],
  ["p33", "p24", "Cacciatori 1", "blue", 0.2, 2],
  ["p24", "p30", "Cacciatori 1", "blue", 0.1, 2],
  ["p30", "laghetdoss2", "Cacciatori 1", "blue", 0.3, 2],
  ...
  ["pratidigaggia", "p33", "Gaggia", "red", 0.8, 3],
  ["laselletta", "p38", "Dosso Larici", "red", 1.6, 5],
  ["p38", "meriz2", "Dosso Larici", "red", 0.6, 2],
  ["meriz2", "meriz", "Dosso Larici", "red", 0.2, 2],
  ["p34", "p35", "Traliccio", "red", 0.5, 2],
  ["laselletta", "p35", "Tre-Tre (selletta)", "red", 0.7, 2],
  ["p35", "albidemez", "Tre-Tre (selletta)", "red", 0.1, 2],
  ...
  ["p38", "meriz5", "Nuvola Rossa", "red", 0.3, 2],
  ...
  ["salareconca2", "p41", "Skiweg conca d'argento", "blue", 0.6, 2],
  ...
  ["santantonio", "p47", "Paganella 2", "red", 1, 3],
  ["p47", "pratidigaggia", "Paganella 2", "red", 0.6, 2],
  ["santantonio3", "salareconca", "Skiweg lo Scoiattolo", "blue", 0.4, 2],
  ["paganella", "p46", "Nuvola Rossa", "red", 0.7, 2],
  ["p46", "meriz5", "Nuvola Rossa", "red", 1.5, 5],
  ...
  ["santantonio", "p47", "Lupetto", "red", 0.8, 3],
  ["laselletta", "p48", "Jana Granda (N)", "red", 1.2, 4],
  ["p48", "piandosson3", "Jana Granda (N)", "red", 0.8, 3],
  ["piandosson3", "piandosson", "Pian Dosson link", "red", 0.3, 2],
  ["albidemez", "p48", "Gallo Cedrone", "red", 0.4, 2],
